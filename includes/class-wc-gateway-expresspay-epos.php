...
class WC_Gateway_ExpressPay_Epos extends WC_Payment_Gateway {
	...
	public function admin_options() {
		...
		<div style="margin-left: 6px; margin-top: 15px; display: inline-block;">
			<?php _e("Express Payments: EPOS - plugin for integration with the Express Payments service (express-pay.by) via API.", 'wordpress_epos_expresspay').
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'send_client_sms' => array(
				'title'   => __('Send SMS notification to client', 'wordpress_epos_expresspay'),
				'type'    => 'checkbox'
			),
			'use_public_invoice' => array(
				'title'   => __('Redirection to a public invoice', 'wordpress_epos_expresspay'),
				'type'    => 'checkbox'
			),
			'test_mode' => array(
				'title'   => __('Use test mode', 'wordpress_epos_expresspay'),
